 ...
 */
void *idr_remove(struct idr *idr, u64 id)
{
 ...
 */
void *idr_find(const struct idr *idr, u64 id)
{
 ...
 * nextid must be incremented by the user.
 */
void *idr_get_next_ul(struct idr *idr, u64 *nextid)
{
	struct radix_tree_iter iter;
	void __rcu **slot;
	u64 base = idr->idr_base;
 ...
 */
void *idr_replace(struct idr *idr, void *ptr, u64 id)
{
